...
LiskAPI.prototype.netHashOptions = function () {
	return {
		testnet: {
			...
			'broadhash': 'c16656e85880df9a41abed0aa13b2987b0d853adadc91cbc7e5c8332ea37ccc9',
			'os': 'lisk-js-api',
			'version': '0.1.1',
			'minVersion': '>=0.1.1',
			'port': this.port
		...
		mainnet: {
			...
			'broadhash': '704f232786a9bff25d0630c06abbc34957448ba6309d6dcef949cf9a6f43954a',
			'os': 'lisk-js-api',
			'version': '0.1.1',
			'minVersion': '>=0.1.1',
			'port': this.port
